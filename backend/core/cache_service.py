    ...
    async with AsyncSessionLocal() as db:
        ...
        for row in rows:
            temp_cache.append({
                ...
                # --- Điều kiện phụ chuẩn hóa cho LLM (khớp với tools.py) ---
                "hoc_ba_tb_3_nam_min": row.hoc_ba_tbc_3_nam,
                "diem_tot_nghiep_min": row.diem_tot_nghiep,
                "ngoai_ngu_tb_3_nam_min": row.tbc_3_nam_ngoai_ngu,
                "hoc_luc_12_min": row.hoc_luc_12,
                "nang_khieu_min": row.nang_khieu,
                "tieng_anh_min": row.tieng_anh,
                "ngoai_ngu_min": row.ngoai_ngu,
